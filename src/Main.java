...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        phy = new Physics();
        Piston p = new Piston(new Pair(100,100),new Pair(.2,.5),0,1,1,new Circle(15),arr,phy);
        Piston p1 = new Piston(new Pair(201,100),new Pair(-.1,.3),0,1,1,new Circle(15),arr,phy);
